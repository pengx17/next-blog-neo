...
export const PreviewCard = React.forwardRef(function PreviewCard(
  ...
  return (
    <a
      className="block cursor-pointer select-none rounded-md border border-gray-200 overflow-hidden max-w-[90vw] hover:border-blue-200 shadow-xs transition"
      href={data.url}
      ref={ref}
    ...
    >
      <span className="h-full bg-gray-50 flex justify-between items-stretch">
        <span className="py-3 px-4 flex-2 overflow-hidden flex-col flex">
          ...
          <span className="leading-5 text-xs font-normal text-gray-500 mt-1.5 flex grow overflow-auto">
            {data.description}
          </span>
